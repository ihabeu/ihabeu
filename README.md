...
Built a 12-state multi-state survival model (Cox PH) for 2,279 hematologic cancer patients using R mstate.
Quantified transition probabilities and risk factors across recovery, relapse, and mortality states.
